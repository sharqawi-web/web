...
),jQuery.Velocity?console.log("Velocity is already loaded. You may be needlessly importing Velocity again;
  note that Materialize includes Velocity."):(!function(t) {
  function e(t) {
...
n) {
  ...
  if(n) {
  if(s)for(;
  o>r&&(a=i.apply(t[r],n),a!==!1);
  r++);
  else for(r in t)if(a=i.apply(t[r],n),a===!1)break;
}

else if(s)for(;
  o>r&&(a=i.call(t[r],r,t[r]),a!==!1);
  r++);
...
"object"!=typeof s&&"function"!==i.type(s)&&(s= {}
  ...
  u>l;
  l++)if(null!=(r=arguments[l]))for(a in r)t=s[a],
n=r[a],
...
i) {
  var n=i||[];
  return null!=t&&(e(Object(t))?!function(t,
e) {
  for(var i=+e.length,n=0,a=t.length;
  i>n;
  )t[a++]=e[n++];
  if(i!==i)for(;
  void 0!==e[n];
...
;
  return {
  top:e.top+(t.pageYOffset||document.scrollTop||0)-(document.clientTop||0),left:e.left+(t.pageXOffset||document.scrollLeft||0)-(document.clientLeft||0);
}
}
...
position:function() {
  function t() {
  for(var t=this.offsetParent||document;
...
,r=a.hasOwnProperty,o=a.toString,s="Boolean Number String Function Array Date RegExp Object Error".split(" "),l=0;
  l<s.length;
  l++)a["[object "+s[l]+"]"]=s[l].toLowerCase();
...
a) {
  var r,o,s=0;
  do o=i+(a-i)/2,r=l(o,t,n)-e,r>0?a=o:i=o;
  while(Math.abs(r)>m&&++s<y);
  return o;
}

function f(e) {
  for(var i=0,a=1,r=b-1;
  a!=r&&k[a]<=e;
  ++a)i+=w;
  --a;
...
if(E.currentValue=A,"tween"===P)g=A;
  ...
  var _=x.Hooks.getRoot(P),I=o(T).rootPropertyValueCache[_];
...
e) {
  ...
  for(var i=b.State.calls[t][0],a=b.State.calls[t][1],r=b.State.calls[t][2],s=b.State.calls[t][4],l=!1,u=0,c=i.length;
  c>u;
  u++) {
  var d=i[u].element;
...
"display",
r.display),
"hidden"===r.visibility&&x.setPropertyValue(d,
"visibility",
r.visibility)),
...
s&&r.loop!==!0&&s(a),
o(d)&&r.loop===!0&&!e&&(p.each(o(d).tweensContainer,
function(t,
e) {
...
b.State.calls[t]=!1;
  for(var v=0,g=b.State.calls.length;
  g>v;
  v++)if(b.State.calls[v]!==!1) {
  l=!0;
  break;
}
...
Promise:e.Promise,
defaults: {
  queue:"",duration:m,easing:y,begin:n,complete:n,progress:n,display:n,visibility:n,loop:!1,delay:!1,mobileHA:!0,_cacheValues:!0;
}
...
,u=[0],c=0,d=1e-4,p=.016;
  for(t=parseFloat(t)||500,e=parseFloat(e)||20,a=a||null,l.tension=t,l.friction=e,r=null!==a,r?(c=n(t,e),o=c/a*p):o=p;
  s=i(s||l,o),u.push(1+s.x),c+=16,Math.abs(s.x)>d&&Math.abs(s.v)>d;
  );
  return r?function(t) {
...
Hooks: {
  templates: {
  textShadow:["Color X Y Blur","black 0 0 0"],boxShadow:["Color X Y Blur Spread","black 0 0 0 0"],clip:["Top Right Bottom Left","0px 0 0 0"],backgroundPosition:["X Y","0% 0%"],transformOrigin:["X Y Z","50% 50% 0"],perspectiveOrigin:["X Y","50% 50%"];
}
...
return n;
  case"inject":return parseFloat(i)?"blur("+i+")":"none";
}
}
...
i) {
  ...
  case"inject":return e.style.zoom=1,parseFloat(i)>=1?"":"alpha(opacity="+parseInt(100*parseFloat(i),10)+")";
}

else switch(t) {
  case"name":return"opacity";
  case"extract":return i;
  case"inject":return i;
}
}
;
}
...
register:function() {
  ...
  for(var t=0;
  t<x.Lists.transformsBase.length;
  t++)!function() {
  var e=x.Lists.transformsBase[t];
  x.Normalizations.registered[e]=function(t,
i,
a) {
  switch(t) {
  case"name":return"transform";
  case"extract":return o(i)===n||o(i).transformCache[e]===n?/^scale/i.test(e)?1:0:o(i).transformCache[e].replace(/[()]/g,"");
  case"inject":var r=!1;
  switch(e.substr(0,
e.length-1)) {
  case"translate":r=!/(%|px|em|rem|vw|vh|\d)$/i.test(a);
  break;
  case"scal":case"scale":b.State.isAndroid&&o(i).transformCache[e]===n&&1>a&&(a=1),r=!/(\d)$/i.test(a);
  break;
  case"skew":r=!/(deg|\d)$/i.test(a);
  break;
  case"rotate":r=!/(deg|\d)$/i.test(a);
}
...
return 8>=f||3!==r.split(" ").length||(r+=" 1"),r;
  case"inject":return 8>=f?4===a.split(" ").length&&(a=a.split(/\s+/).slice(0,3).join(" ")):3===a.split(" ").length&&(a+=" 1"),(8>=f?"rgb":"rgba")+"("+a.replace(/\s+/g,",").replace(/\.(\d)+(?=,)/g,"")+")";
}
}
;
}
...
t,
n),
i=x.Normalizations.registered[i]("name",
t)),
...
var i="";
  ...
  var n= {
  translate:[e("translateX"),e("translateY")],skewX:[e("skewX")],skewY:[e("skewY")],scale:1!==e("scale")?[e("scale"),e("scale")]:[e("scaleX"),e("scaleY")],rotate:[e("rotateZ"),0,0];
}

;
  p.each(o(t).transformCache,
function(t) {
...
function f() {
  var t= {
  myParent:r.parentNode||i.body,position:x.getPropertyValue(r,"position"),fontSize:x.getPropertyValue(r,"fontSize");
}

,n=t.position===V.lastPosition&&t.myParent===V.lastParent,a=t.fontSize===V.lastFontSize;
...
if("scroll"===A) {
  var w,C,S,O=/^x$/i.test(s.axis)?"Left":"Top",E=parseFloat(s.offset)||0;
  s.container?v.isWrapped(s.container)||v.isNode(s.container)?(s.container=s.container[0]||s.container,
w=s.container["scroll"+O],
S=w+p(r).position()[O.toLowerCase()]+E):s.container=null:(w=b.State.scrollAnchor[b.State["scrollProperty"+O]],
C=b.State.scrollAnchor[b.State["scrollProperty"+("Left"===O?"Top":"Left")]],
S=p(r).offset()[O.toLowerCase()]+E),
l= {
  scroll: {
  rootPropertyValue:!1,
startValue:w,
...
easing:s.easing,
scrollData: {
  container:s.container,direction:O,alternateValue:C;
}
}
...
,o(r).tweensContainer);
  for(var M in q)if("element"!==M) {
  var _=q[M].startValue;
  q[M].startValue=q[M].currentValue=q[M].endValue,q[M].endValue=_,v.isEmptyObject(y)||(q[M].easing=s.easing),b.debug&&console.log("reverse tweensContainer ("+M+"):"+JSON.stringify(q[M]),r);
}
...
l=q;
  ...
  var q;
  o(r).tweensContainer&&o(r).isAnimating===!0&&(q=o(r).tweensContainer),
p.each(g,
function(e,
i) {
  ...
  for(var l=["Red","Green","Blue"],u=x.Values.hexToRgb(r),c=s?x.Values.hexToRgb(s):n,d=0;
  d<l.length;
  d++) {
  var p=[u[d]];
...
;
  ...
  for(var I in g) {
  var D=t(g[I]),z=D[0],Q=D[1],L=D[2];
  I=x.Names.camelCase(I);
  var $=x.Hooks.getRoot(I),N=!1;
  if(o(r).isSVG||"tween"===$||x.Names.prefixCheck($)[1]!==!1||x.Normalizations.registered[$]!==n) {
  (s.display!==n&&null!==s.display&&"none"!==s.display||s.visibility!==n&&"hidden"!==s.visibility)&&/opacity|filter/.test(I)&&!L&&0!==z&&(L=0),s._cacheValues&&q&&q[I]?(L===n&&(L=q[I].endValue+q[I].unitType),N=o(r).rootPropertyValueCache[$]):x.Hooks.registered[I]?L===n?(N=x.getPropertyValue(r,$),L=x.getPropertyValue(r,I,N)):N=x.Hooks.templates[$][1]:L===n&&(L=x.getPropertyValue(r,I));
  var F,W,X,R=!1;
  if(F=d(I,
L),
L=F[0],
...
),W=F[1],L=parseFloat(L)||0,z=parseFloat(z)||0,"%"===W&&(/^(fontSize|lineHeight)$/.test(I)?(z/=100,W="em"):/^scale/.test(I)?(z/=100,W=""):/(Red|Green|Blue)$/i.test(I)&&(z=z/100*255,W="")),/[\/*]/.test(R))W=X;
  else if(X!==W&&0!==L)if(0===z)W=X;
  else {
  a=a||f();
  var H=/margin|padding|left|right|width|text|word|letter/i.test(I)||/X$/.test(I)||"x"===I?"x":"y";
  switch(X) {
  case"%":L*="x"===H?a.percentToPxWidth:a.percentToPxHeight;
  break;
  case"px":break;
  default:L*=a[X+"ToPx"];
}
...
switch(W) {
  case"%":L*=1/("x"===H?a.percentToPxWidth:a.percentToPxHeight);
  break;
  case"px":break;
  default:L*=1/a[W+"ToPx"];
}
}
...
l[I]= {
  rootPropertyValue:N,startValue:L,currentValue:L,endValue:z,unitType:W,easing:Q;
}
...
parseFloat(s.delay)&&s.queue!==!1&&p.queue(r,
s.queue,
function(t) {
  b.velocityQueueEntryFlag=!0,
o(r).delayTimer= {
  setTimeout:setTimeout(t,parseFloat(s.delay)),next:t;
}
}
...
s.queue===!1?s.delay?setTimeout(t,
s.delay):t():p.queue(r,
s.queue,
function(e,
i) {
...
;
  for(var O=S;
  O<arguments.length;
  O++)v.isArray(arguments[O])||!/^(fast|normal|slow)$/i.test(arguments[O])&&!/^\d/.test(arguments[O])?v.isString(arguments[O])||v.isArray(arguments[O])?y.easing=arguments[O]:v.isFunction(arguments[O])&&(y.complete=arguments[O]):y.duration=arguments[O];
}
...
;
  s&&b.Promise&&(P.promise=new b.Promise(function(t,
e) {
  ...
  break;
  case"finish":case"stop":p.each(h,
function(t,
e) {
...
a) {
  var r=y===n?"":y;
  return r===!0||e[2].queue===r||y===n&&e[2].queue===!1?void p.each(h,
function(i,
n) {
  n===a&&((y===!0||v.isString(y))&&(p.each(p.queue(n,
v.isString(y)?y:""),
function(t,
e) {
...
v.isString(y)?y:"",
[])),
"stop"===g?(o(n)&&o(n).tweensContainer&&r!==!1&&p.each(o(n).tweensContainer,
function(t,
e) {
...
e) {
  ...
  default:if(!p.isPlainObject(g)||v.isEmptyObject(g)) {
  if(v.isString(g)&&b.Redirects[g]) {
  var q=p.extend( {}

,y),M=q.duration,_=q.delay||0;
  return q.backwards===!0&&(h=p.extend(!0,
[],
h).reverse()),
p.each(h,
function(t,
e) {
  parseFloat(q.stagger)?q.delay=_+parseFloat(q.stagger)*t:v.isFunction(q.stagger)&&(q.delay=_+q.stagger.call(e,
t,
k)),
q.drag&&(q.duration=parseFloat(M)||(/^(callout|transition)/.test(g)?1e3:m),
q.duration=Math.max(q.duration*(q.backwards?1-t/k:(t+1)/k),
.75*q.duration,
200)),
b.Redirects[g].call(e,
e,
q|| {}
...
,b.defaults,y);
  if(q.loop=parseInt(q.loop),D=2*q.loop-1,q.loop)for(var z=0;
  D>z;
  z++) {
  var Q= {
  delay:q.delay,progress:q.progress;
}
...
function(t,
e) {
  b.Redirects["slide"+e]=function(t,
i,
a,
r,
o,
...
return i&&(n=e?n.sort(function(t,
i) {
  return t[e]>i[e];
}
...
function x(t,
e) {
  for(var i,a,r=e[0].toUpperCase()+e.slice(1),o=0;
  o<lt.length;
  ) {
...
function S(t) {
  ...
  return new(e=i?i:mt?L:yt?F:gt?X:Q)(t,O);
}

function O(t,
e,
i) {
  var n=i.pointers.length,a=i.changedPointers.length,r=e&Tt&&0===n-a,o=e&(Ot|Pt)&&0===n-a;
  i.isFirst=!!r,
i.isFinal=!!o,
r&&(t.session= {}

),i.eventType=e,P(t,i),t.emit("hammer.input",i),t.recognize(i),t.session.prevInput=i;
}
...
e) {
  ...
  var r=i.firstInput,o=i.firstMultiple,s=o?o.center:r.center,l=e.center=M(n);
...
function q(t) {
  ...
  clientX:dt(t.pointers[i].clientX),clientY:dt(t.pointers[i].clientY);
}

,i++;
  return {
  timeStamp:ft(),pointers:e,center:M(e),deltaX:t.deltaX,deltaY:t.deltaY;
}
}
...
function M(t) {
  var e=t.length;
  if(1===e)return {
  x:dt(t[0].clientX),y:dt(t[0].clientY);
}
...
function Q() {
  this.evEl=Lt,this.evWin=$t,this.allow=!0,this.pressed=!1,T.apply(this,arguments);
}

function L() {
  this.evEl=Wt,this.evWin=Xt,T.apply(this,arguments),this.store=this.manager.session.pointerEvents=[];
}
...
e) {
  ...
  a<r.length;
  )n[r[a].identifier]=!0,a++;
  for(a=0;
  a<o.length;
  )n[o[a].identifier]&&s.push(o[a]),e&(Ot|Pt)&&delete n[o[a].identifier],a++;
...
,
this.defaults),
this.options.enable=p(this.options.enable,
!0),
this.state=ae,
this.simultaneous= {}
...
,e.recognizers=p(e.recognizers,at.defaults.preset),new rt(t,e);
}
...
var lt=["","webkit","moz","MS","ms","o"],ut=e.createElement("div"),ct="function",dt=Math.round,pt=Math.abs,ft=Date.now,ht=1,vt=/mobile|tablet|ip(ad|hone|od)|android/i,gt="ontouchstart"in t,mt=x(t,"PointerEvent")!==n,yt=gt&&vt.test(navigator.userAgent),bt="touch",wt="pen",xt="mouse",Ct="kinect",kt=25,Tt=1,St=2,Ot=4,Pt=8,At=1,Et=2,qt=4,Mt=8,_t=16,It=Et|qt,Vt=Mt|_t,jt=It|Vt,Dt=["x","y"],zt=["clientX","clientY"];
  T.prototype= {
  handler:function() {}
...
;
  var Qt= {
  mousedown:Tt,mousemove:St,mouseup:Ot;
}

,Lt="mousedown",$t="mousemove mouseup";
  u(Q,
T,
 {
  handler:function(t) {
...
e,
 {
  pointers:[t],changedPointers:[t],pointerType:xt,srcEvent:t;
}
  ...
  var Nt= {
  pointerdown:Tt,pointermove:St,pointerup:Ot,pointercancel:Pt,pointerout:Pt;
}
...
,Wt="pointerdown",Xt="pointermove pointerup pointercancel";
...
T,
 {
  handler:function(t) {
  var e=this.store,i=!1,n=t.type.toLowerCase().replace("ms",""),a=Nt[n],r=Ft[t.pointerType]||t.pointerType,o=r==bt,s=y(e,t.pointerId,"pointerId");
  a&Tt&&(0===t.button||o)?0>s&&(e.push(t),
s=e.length-1):a&(Ot|Pt)&&(i=!0),
0>s||(e[s]=t,
this.callback(this.manager,
a,
 {
  ...
  var Rt= {
  touchstart:Tt,touchmove:St,touchend:Ot,touchcancel:Pt;
}

,Ht="touchstart",Yt="touchstart touchmove touchend touchcancel";
  u($,
T,
 {
  handler:function(t) {
...
this.started) {
  ...
  e&(Ot|Pt)&&0===i[0].length-i[1].length&&(this.started=!1),
this.callback(this.manager,
e,
 {
...
T,
 {
  handler:function(t) {
  var e=Bt[t.type],i=W.call(this,t,e);
  i&&this.callback(this.manager,
e,
 {
  pointers:i[0],changedPointers:i[1],pointerType:bt,srcEvent:t;
}
...
e,
i) {
  var n=i.pointerType==bt,a=i.pointerType==xt;
...
destroy:function() {
  ...
  var Ut=x(ut.style,"touchAction"),Zt=Ut!==n,Jt="compute",Kt="auto",te="manipulation",ee="none",ie="pan-x",ne="pan-y";
  R.prototype= {
  set:function(t) {
...
preventDefaults:function(t) {
  ...
  var n=this.actions,a=g(n,ee),r=g(n,ne),o=g(n,ie);
...
;
  var ae=1,re=2,oe=4,se=8,le=se,ue=16,ce=32;
  Y.prototype= {
  defaults: {}
...
,
process:function(t) {
  var e=this.state,i=t.eventType,n=e&(re|oe),a=this.attrTest(t);
...
Z,
 {
  defaults: {
  event:"pan",threshold:10,pointers:1,direction:jt;
}
...
process:function(t) {
  ...
  else if(t.eventType&Tt)this.reset(),
...
Z,
 {
  defaults: {
  event:"swipe",threshold:10,velocity:.65,direction:It|Vt,pointers:1;
}
...
process:function(t) {
  ...
  var o=this.pTime?t.timeStamp-this.pTime<e.interval:!0,s=!this.pCenter||V(this.pCenter,t.center)<e.posThreshold;
...
recognize:function(t) {
  ...
  for(var r=0;
  r<n.length;
  )i=n[r],e.stopped===pe||a&&i!=a&&!i.canRecognizeWith(a)?i.reset():i.recognize(t),!a&&i.state&(re|oe|se)&&(a=e.curRecognizer=i),r++;
}
}
...
get:function(t) {
  ...
  i<e.length;
  i++)if(e[i].options.event==t)return e[i];
  return null;
}
...
s(at,
 {
  INPUT_START:Tt,INPUT_MOVE:St,INPUT_END:Ot,INPUT_CANCEL:Pt,STATE_POSSIBLE:ae,STATE_BEGAN:re,STATE_CHANGED:oe,STATE_ENDED:se,STATE_RECOGNIZED:le,STATE_CANCELLED:ue,STATE_FAILED:ce,DIRECTION_NONE:At,DIRECTION_LEFT:Et,DIRECTION_RIGHT:qt,DIRECTION_UP:Mt,DIRECTION_DOWN:_t,DIRECTION_HORIZONTAL:It,DIRECTION_VERTICAL:Vt,DIRECTION_ALL:jt,Manager:rt,Input:T,TouchAction:R,TouchInput:F,MouseInput:Q,PointerEventInput:L,TouchMouseInput:X,SingleTouchInput:$,Recognizer:Y,AttrRecognizer:Z,Tap:nt,Pan:J,Swipe:it,Pinch:K,Rotate:et,Press:tt,on:f,off:h,each:o,merge:l,extend:s,inherit:u,bindFn:c,prefixed:x;
}
...
e.parent().hasClass("active")?e.siblings(".collapsible-body").stop(!0,
!1).slideDown( {
  duration:350,
easing:"easeOutQuart",
queue:!1,
...
):e.siblings(".collapsible-body").stop(!0,
!1).slideUp( {
  duration:350,
easing:"easeOutQuart",
queue:!1,
...
s.not(e).parent().children(".collapsible-body").stop(!0,
!1).slideUp( {
  duration:350,
easing:"easeOutQuart",
queue:!1,
...
t.fn.dropdown=function(e) {
  var i= {
  inDuration:300,outDuration:225,constrain_width:!0,hover:!1,gutter:0,belowOrigin:!1,alignment:"left";
}
...
function a(e) {
  ...
  var i=window.innerHeight,a=o.innerHeight(),r=o.offset().left,c=o.offset().top-t(window).scrollTop(),d=s.alignment,p=0,f=0,h=0;
  s.belowOrigin===!0&&(h=a);
  var v=0,g=o.parent();
  if(!g.is("body")&&g[0].scrollHeight>g[0].clientHeight&&(v=g[0].scrollTop),
r+u.innerWidth()>t(window).width()?d="right":r-u.innerWidth()+o.innerWidth()<0&&(d="left"),
c+u.innerHeight()>i)if(c+a-u.innerHeight()<0) {
  var m=i-c-h;
  u.css("max-height",m);
}
...
u.css( {
  position:"absolute",top:o.position().top+h+v,left:f;
}
...
,i,e),l=!1,u=t("#"+o.attr("data-activates"));
  if(n(),
o.after(u),
s.hover) {
  var c=!1;
...
else o.unbind("click."+o.attr("id")),
o.bind("click."+o.attr("id"),
function(e) {
...
a("click")),
u.hasClass("active")&&t(document).bind("click."+u.attr("id")+" touchstart."+u.attr("id"),
function(e) {
...
;
  ...
  var a=t("body"),r=a.innerWidth();
  a.css("overflow","hidden"),a.width(r);
  var o= {
  opacity:.5,in_duration:350,out_duration:250,ready:void 0,complete:void 0,dismissible:!0,starting_top:"4%";
}

,s=t(this);
  s.hasClass("open")||(overlayID=n(),
$overlay=t('<div class="lean-overlay"></div>'),
lStack=++e,
$overlay.attr("id",
overlayID).css("z-index",
1e3+2*lStack),
s.data("overlay-id",
overlayID).css("z-index",
1e3+2*lStack+1),
...
i=t.extend(o,
i),
i.dismissible&&($overlay.click(function() {
  s.closeModal(i);
}

),
t(document).on("keyup.leanModal"+overlayID,
function(t) {
  27===t.keyCode&&s.closeModal(i);
}

)),
s.find(".modal-close").on("click.close",
function() {
  s.closeModal(i);
}
...
,
 {
  duration:i.in_duration,queue:!1,ease:"easeOutCubic";
}

),
s.data("associated-overlay",
$overlay[0]),
...
t.fn.extend( {
  ...
  var n= {
  out_duration:250,complete:void 0;
}

,a=t(this),r=a.data("overlay-id"),o=t("#"+r);
  a.removeClass("open"),
i=t.extend(n,
i),
t("body").css( {
...
,
 {
  duration:i.out_duration,queue:!1,ease:"easeOutQuart";
}
...
complete:function() {
  ...
  top:i.starting_top,opacity:0,scaleX:.7;
}
...
function(t) {
  ...
  function e() {
  r=!1;
  var e=l.parent(".material-placeholder"),n=(window.innerWidth,window.innerHeight,l.data("width")),o=l.data("height");
  l.velocity("stop",
!0),
t("#materialbox-overlay").velocity("stop",
!0),
t(".materialbox-caption").velocity("stop",
!0),
...
,
 {
  duration:s,queue:!1,easing:"easeOutQuad";
}
...
l.css( {
  height:"",top:"",left:"",width:"","max-width":"",position:"","z-index":"";
}
...
l.on("click",
function() {
  var s=l.parent(".material-placeholder"),u=window.innerWidth,c=window.innerHeight,d=l.width(),p=l.height();
  if(r===!1)return e(),!1;
  if(a&&r===!0)return e(),!1;
  for(r=!1,
l.addClass("active"),
a=!0,
s.css( {
  width:s[0].getBoundingClientRect().width,height:s[0].getBoundingClientRect().height,position:"relative",top:0,left:0;
}
...
,
 {
  duration:o,queue:!1,easing:"easeOutQuad";
}
...
complete:function() {
  ...
  height:w,width:b,left:t(document).scrollLeft()+u/2-l.parent(".material-placeholder").offset().left-b/2,top:t(document).scrollTop()+c/2-l.parent(".material-placeholder").offset().top-w/2;
}
...
function(t) {
  ...
  var i,n,a=e.find("li.tab a"),r=e.width(),o=Math.max(r,e[0].scrollWidth)/a.length,s=0;
  i=t(a.filter('[href="'+location.hash+'"]')),0===i.length&&(i=t(this).find("li.tab a.active").first()),0===i.length&&(i=t(this).find("li.tab a").first()),i.addClass("active"),s=a.index(i),0>s&&(s=0),void 0!==i[0]&&(n=t(i[0].hash)),e.append('<div class="indicator"></div>');
...
function(u) {
  ...
  r=e.width(),o=Math.max(r,e[0].scrollWidth)/a.length,i.removeClass("active"),void 0!==n&&n.hide(),i=t(this),n=t(this.hash),a=e.find("li.tab a"),i.addClass("active");
  var c=s;
  s=a.index(t(this)),
0>s&&(s=0),
void 0!==n&&n.show(),
...
i),
this.each(function() {
  var a=Materialize.guid(),r=t(this);
  r.attr("data-tooltip-id",a);
  var o=t("<span></span>").text(r.attr("data-tooltip")),s=t("<div></div>");
...
h="-10px",
l.css( {
  borderRadius:"14px 14px 0 0",transformOrigin:"50% 90%",marginTop:p,marginLeft:f/2-l.width()/2;
}
...
v="-10px",
l.css( {
  width:"14px",height:"14px",borderRadius:"14px 0 0 14px",transformOrigin:"95% 50%",marginTop:p/2,marginLeft:f;
}
...
v="+10px",
l.css( {
  width:"14px",height:"14px",borderRadius:"0 14px 14px 0",transformOrigin:"5% 50%",marginTop:p/2,marginLeft:"0px";
}
...
n=i(r),
 {
  top:a.top+n.pageYOffset-e.clientTop,left:a.left+n.pageXOffset-e.clientLeft;
}
}
...
setTimeout(function() {
  var t= {
  top:o+"px",left:r+"px",opacity:"0","-webkit-transition-duration":u.duration+"ms","-moz-transition-duration":u.duration+"ms","-o-transition-duration":u.duration+"ms","transition-duration":u.duration+"ms","-webkit-transform":s,"-moz-transform":s,"-ms-transform":s,"-o-transform":s,transform:s;
}
...
,"duration"in e&&(u.duration=e.duration),u.wrapInput(l(".waves-effect")),"ontouchstart"in t&&document.body.addEventListener("touchstart",o,!1),document.body.addEventListener("mousedown",o,!1);
}
...
(window),
Materialize.toast=function(t,
e,
i,
n) {
  function a(t) {
  var e=document.createElement("div");
  if(e.classList.add("toast"),i)for(var a=i.split(" "),r=0,o=a.length;
  o>r;
  r++)e.classList.add(a[r]);
...
function(t) {
  ...
  init:function(e) {
  var i= {
  menuWidth:240,edge:"left",closeOnClick:!1;
}
...
var n=t(this),a=t("#"+n.attr("data-activates"));
  ...
  t("body").append(r),
"left"==e.edge?(a.css("transform",
"translateX(-100%)"),
r.css( {
  left:0;
}

)):(a.addClass("right-aligned").css("transform",
"translateX(100%)"),
r.css( {
  right:0;
}
...
a.hasClass("fixed")&&window.innerWidth>992&&a.css("transform",
"translateX(0)"),
a.hasClass("fixed")&&t(window).resize(function() {
  window.innerWidth>992?0!=t("#sidenav-overlay").length&&s?i(!0):a.css("transform","translateX(0%)"):s===!1&&("left"===e.edge?a.css("transform","translateX(-100%)"):a.css("transform","translateX(100%)"));
}

),
e.closeOnClick===!0&&a.on("click.itemclick",
...
function(n) {
  ...
  var r=(n.gesture.direction,n.gesture.center.x),o=(n.gesture.center.y,n.gesture.velocityX,t("body")),l=o.innerWidth();
  if(o.css("overflow",
"hidden"),
o.width(l),
...
if("left"===e.edge&&(r>e.menuWidth?r=e.menuWidth:0>r&&(r=0)),"left"===e.edge)r<e.menuWidth/2?s=!1:r>=e.menuWidth/2&&(s=!0),a.css("transform","translateX("+(r-e.menuWidth)+"px)");
  else {
...
)):(d=Math.abs((r-window.innerWidth)/e.menuWidth),
t("#sidenav-overlay").velocity( {
  opacity:d;
}
...
function(i) {
  ...
  var n=i.gesture.velocityX,l=i.gesture.center.x,u=l-e.menuWidth,c=l-e.menuWidth/2;
  u>0&&(u=0),
0>c&&(c=0),
o=!1,
"left"===e.edge?s&&.3>=n||-.5>n?(0!=u&&a.velocity( {
  translateX:[0,u];
}
...
function(t) {
  t(document).ready(function() {
  function e(e) {
  var i=e.css("font-family"),n=e.css("font-size");
...
;
  ...
  t(document).on("keyup.radio",
n,
function(e) {
  if(9===e.which) {
  t(this).addClass("tabbed");
  var i=t(this);
  return void i.one("blur",
function() {
...
t("body").on("keyup keydown autoresize",
r,
function() {
  e(t(this));
}
...
function() {
  for(var e=t(this).closest(".file-field"),i=e.find("input.file-path"),n=t(this)[0].files,a=[],r=0;
  r<n.length;
  r++)a.push(n[r].name);
...
t(document).on("input mousedown touchstart",
s,
function(e) {
...
t(document).on("mouseup touchend",
u,
function() {
...
t(document).on("mousemove touchmove",
u,
function(e) {
...
t(document).on("mouseout touchleave",
u,
function() {
  if(!l) {
...
t(this).each(function() {
  ...
  var a=!!n.attr("multiple"),r=n.data("select-id");
...
i,
n) {
  var a=i.is(":disabled")?"disabled ":"",r="optgroup-option"===n?"optgroup-option ":"",o=i.data("icon"),s=i.attr("class");
  if(o) {
  var u="";
  return s&&(u=' class="'+s+'"'),"multiple"===n?l.append(t('<li class="'+a+'"><img src="'+o+'"'+u+'><span><input type="checkbox"'+a+"/><label></label>"+i.html()+"</span></li>")):l.append(t('<li class="'+a+r+'"><img src="'+o+'"'+u+"><span>"+i.html()+"</span></li>")),!0;
}

"multiple"===n?l.append(t('<li class="'+a+'"><span><input type="checkbox"'+a+"/><label></label>"+i.html()+"</span></li>")):l.append(t('<li class="'+a+r+'"><span>'+i.html()+"</span></li>"));
}
...
),s=i(c,t(this).index(),n),g.trigger("focus")):(l.find("li").removeClass("active"),t(this).toggleClass("active"),g.val(t(this).text())),m(l,t(this)),n.find("option").eq(r).prop("selected",s),n.trigger("change"),"undefined"!=typeof e&&e();
}
...
n.is(":disabled")||g.dropdown( {
  hover:!1,closeOnClick:!1;
}

),
n.attr("tabindex")&&t(g[0]).attr("tabindex",
n.attr("tabindex")),
...
u.each(function() {
  ...
  i.click(function() {
  var i=l.parent(),a=i.find(t(this)).index();
  n(a),
clearInterval(o),
...
!f&&!p||u.length<=1?$curr_slide.velocity( {
  translateX:0;
}
...
):(t(e.target).is(t(".card .activator"))||t(e.target).is(t(".card .activator i")))&&(t(e.target).closest(".card").css("overflow",
"hidden"),
...
t(document).on("mouseenter.fixedActionBtn",
...
t(document).on("mouseleave.fixedActionBtn",
".fixed-action-btn:not(.click-to-toggle)",
function() {
  var e=t(this);
  i(e);
...
t(document).on("click.fixedActionBtn",
".fixed-action-btn.click-to-toggle > a",
function() {
  var n=t(this),a=n.parent();
...
$this.find("ul .btn-floating").velocity( {
  scaleY:".4",scaleX:".4",translateY:i+"px",translateX:n+"px";
}
...
$this.find("ul .btn-floating").velocity("stop",
!0),
$this.find("ul .btn-floating").velocity( {
...
i) {
  ...
  100>a&&(a=100),
e>=0&&t(this).css( {
  "-webkit-filter":"grayscale("+n+")brightness("+a+"%)",filter:"grayscale("+n+")brightness("+a+"%)";
}
...
"touch"===n.gesture.pointerType) {
  ...
  if(e||i) {
  var r;
  r=e?a.innerWidth():-1*a.innerWidth(),
a.velocity( {
  translateX:r;
}
...
setInterval(function() {
  if(e) {
  e=!1;
  for(var i=window.pageYOffset+window.innerHeight,n=0;
  n<t.length;
  n++) {
...
function f() {
  C.data(o,
T).addClass(x.input).attr("tabindex",
-1).val(C.data("value")?T.get("select",
w.format):r.value),
w.editable||C.on("focus."+b.id+" click."+b.id,
function(t) {
...
a(r,
 {
  haspopup:!0,expanded:!1,readonly:!1,owns:r.id+"_root";
}
...
function() {
  ...
  a=a&&(a.type||a.href),
(n||a&&!t.contains(T.$root[0],
a))&&T.$root.eq(0).focus(),
!n&&i.nav?T.set("highlight",
...
r.name=""):(e=["string"==typeof w.hiddenPrefix?w.hiddenPrefix:"",
"string"==typeof w.hiddenSuffix?w.hiddenSuffix:"_submit"],
e=e[0]+r.name+e[1]),
T._hidden=t('<input type=hidden name="'+e+'"'+(C.data("value")||r.value?' value="'+T.get("select",
w.formatSubmit)+'"':"")+">")[0],
C.on("change."+b.id,
function() {
...
i!==!1&&(b.open=!0,
y&&c.css("overflow",
"hidden").css("padding-right",
"+="+n()),
T.$root.eq(0).focus(),
u.on("click."+b.id+" focusin."+b.id,
function(t) {
  var e=t.target;
...
function(i) {
  var n=i.keyCode,a=T.component.key[n],r=i.target;
...
off:function() {
  var t,e,i=arguments;
  for(t=0,namesCount=i.length;
  t<namesCount;
  t+=1)e=i[t],e in b.methods&&delete b.methods[e];
  return T;
}
...
function n() {
  ...
  var e=t('<div style="visibility:hidden;
  width:100px" />').appendTo("body"),i=e[0].offsetWidth;
...
e._= {
  group:function(t) {
  for(var i,n="",a=e._.trigger(t.min,t);
  a<=e._.trigger(t.max,t,[a]);
  a+=t.i)i=e._.trigger(t.item,t,[a]),n+=e._.node(t.node,i[0],i[1],i[2]);
  return n;
}
...
r) {
  var o=this.data(i);
  return"picker"==a?o:o&&"string"==typeof a?e._.trigger(o[a],
o,
...
t.on("render",
function() {
  t.$root.find("."+e.klass.selectMonth).on("change",
function() {
  var i=this.value;
...
t.$root.find("."+e.klass.selectYear).on("change",
function() {
  var i=this.value;
...
i==-(1/0)||i==1/0?a=i:e.isPlainObject(i)&&r.isInteger(i.pick)?i=i.obj:e.isArray(i)?(i=new Date(i[0],
i[1],
i[2]),
i=r.isDate(i)?i:o.create().obj):i=r.isInteger(i)||r.isDate(i)?o.normalize(new Date(i),
n):o.now(t,
i,
n),
 {
...
,
i.prototype.createRange=function(t,
i) {
  var n=this,
a=function(t) {
...
r.isInteger(i)||(i=a(i)),
r.isInteger(t)&&e.isPlainObject(i)?t=[i.year,
i.month,
i.date+t]:r.isInteger(i)&&e.isPlainObject(t)&&(i=[t.year,
t.month,
t.date+i]),
 {
  from:a(t),to:a(i);
...
,
i.prototype.withinRange=function(t,
e) {
  return t=this.createRange(t.from,t.to),e.pick>=t.from.pick&&e.pick<=t.to.pick;
}

,
i.prototype.overlapRanges=function(t,
e) {
  var i=this;
...
n) {
  ...
  if(l||u) {
  for(u?(r=i.year,o=i.month,s=i.date):(r=+i[0],o=+i[1],s=+i[2]),n&&n.nav&&c&&c.month!==o&&(r=c.year,o=c.month),a=new Date(r,o+(n&&n.nav?n.nav:0),1),r=a.getFullYear(),o=a.getMonth();
...
e) {
  var i=this;
  return e?"string"==typeof e?e=i.parse(t,
e):r.isInteger(e)&&(e=i.now(t,
e,
 {
  rel:e;
}
...
,
i.prototype.viewset=function(t,
e) {
...
return r.isInteger(t);
  ...
  if((!n||!n.nav)&&(!p&&u.disabled(i)||p&&u.disabled(i)&&(v||a||o)||!p&&(i.pick<=f.pick||i.pick>=h.pick)))for(p&&!v&&(!o&&d>0||!a&&0>d)&&(d*=-1);
  u.disabled(i)&&(Math.abs(d)>1&&(i.month<c.month||i.month>c.month)&&(i=c,d=d>0?1:-1),i.pick<=f.pick?(s=!0,d=1,i=u.create([f.year,f.month,f.date+(i.pick===f.pick?0:-1)])):i.pick>=h.pick&&(l=!0,d=-1,i=u.create([h.year,h.month,h.date+(i.pick===h.pick?0:1)])),!s||!l);
...
(),
i.prototype.isDateExact=function(t,
i) {
  var n=this;
...
,
i.prototype.isDateOverlap=function(t,
i) {
...
v=function(t) {
  return r.node("div",
" ",
i.klass["nav"+(t?"Next":"Prev")]+(t&&c.year>=f.year&&c.month>=f.month||!t&&c.year<=p.year&&c.month<=p.month?" "+i.klass.navDisabled:""),
"data-nav="+(t||-1)+" "+r.ariaAttr( {
  role:"button",controls:e.$node[0].id+"_table";
}
...
i.selectMonths&&void 0==n?r.node("select",
r.group( {
  min:0,
max:11,
i:1,
...
r.node("div",
createWeekdayLabel(),
"picker__weekday-display")+r.node("div",
g("short_months"),
i.klass.month_display)+r.node("div",
createDayLabel(),
i.klass.day_display)+r.node("div",
m("raw"),
i.klass.year_display),
i.klass.date_display)+r.node("div",
r.node("div",
(i.selectYears?g()+m():g()+m())+v()+v(1),
i.klass.header)+r.node("table",
h+r.node("tbody",
r.group( {
  min:0,
max:a-1,
...
"data-pick="+t.pick+" "+r.ariaAttr( {
  role:"gridcell",label:h,selected:n&&e.$node.val()===h?!0:null,activedescendant:a?!0:null,disabled:o?!0:null;
}
...
i.klass.table,
'id="'+e.$node[0].id+'_table" '+r.ariaAttr( {
  role:"grid",controls:e.$node[0].id,readonly:!0;
}

)),
i.klass.calendar_container)+r.node("div",
r.node("button",
i.today,
"btn-flat picker__today",
"type=button data-pick="+s.pick+(t&&!e.disabled(s)?"":" disabled")+" "+r.ariaAttr( {
  controls:e.$node[0].id;
}
...
"type=button data-clear=1"+(t?"":" disabled")+" "+r.ariaAttr( {
  controls:e.$node[0].id;
}
...
"type=button data-close=true "+(t?"":" disabled")+" "+r.ariaAttr( {
  controls:e.$node[0].id;
}
...
t.fn.characterCounter=function() {
  return this.each(function() {
  var a=t(this),r=a.parent().find('span[class="character-counter"]');
  if(!r.length) {
...
function(t) {
  ...
  init:function(e) {
  var i= {
  time_constant:200,dist:-100,shift:0,padding:0,full_width:!1;
}
...
function o(t) {
  var i,n,a,o,s,l,u;
  for(h="number"==typeof t?t:h,v=Math.floor((h+m/2)/m),a=h-v*m,o=0>a?1:-1,s=-o*a*2/m,e.full_width?u="translateX(0)":(u="translateX("+(M[0].clientWidth-item_width)/2+"px) ",u+="translateY("+(M[0].clientHeight-item_width)/2+"px)"),l=f[r(v)],l.style[S]=u+" translateX("+-a/2+"px) translateX("+o*e.shift*s*i+"px) translateZ("+e.dist*s+"px)",l.style.zIndex=0,e.full_width?tweenedOpacity=1:tweenedOpacity=1-.2*s,l.style.opacity=tweenedOpacity,n=b>>1,i=1;
  n>=i;
  ++i)e.full_width?(zTranslation=e.dist,tweenedOpacity=i===n&&0>a?1-s:1):(zTranslation=e.dist*(2*i+s*o),tweenedOpacity=1-.2*(2*i+s*o)),l=f[r(v+i)],l.style[S]=u+" translateX("+(e.shift+(m*i-a)/2)+"px) translateZ("+zTranslation+"px)",l.style.zIndex=-i,l.style.opacity=tweenedOpacity,e.full_width?(zTranslation=e.dist,tweenedOpacity=i===n&&a>0?1-s:1):(zTranslation=e.dist*(2*i-s*o),tweenedOpacity=1-.2*(2*i-s*o)),l=f[r(v-i)],l.style[S]=u+" translateX("+(-e.shift+(-m*i-a)/2)+"px) translateZ("+zTranslation+"px)",l.style.zIndex=-i,l.style.opacity=tweenedOpacity;
  l=f[r(v)],l.style[S]=u+" translateX("+-a/2+"px) translateX("+o*e.shift*s+"px) translateZ("+e.dist*s+"px)",l.style.zIndex=0,e.full_width?tweenedOpacity=1:tweenedOpacity=1-.2*s,l.style.opacity=tweenedOpacity;
}
...
function u(i) {
  ...
  if(!e.full_width) {
  var n=t(i.target).closest(".carousel-item").index(),a=v%b-n;
...
function d(t) {
  var e,i,r;
  if(g)if(e=n(t),y=a(t),i=w-e,r=Math.abs(x-y),30>r&&!q)(i>2||-2>i)&&(E=!0,w=e,o(h+i));
  else {
...
var f,h,v,g,m,b,w,x,C,k,T,S,O,P,A,E,q,M=t(this);
  return M.hasClass("initialized")?!0:(e.full_width&&(e.dist=0,
imageHeight=M.find(".carousel-item img").first().load(function() {
...
h=k=0,
f=[],
item_width=M.find(".carousel-item").first().innerWidth(),
m=2*item_width+e.padding,
M.find(".carousel-item").each(function() {
  f.push(t(this)[0]);
}
